...
// func genericFailure(cfg *shared.Config, err error) (int, shared.Message) {
// 	cfg.Log(1, err)
// 	return 500, shared.Message{Response: "Operation failed"}
// }

// func errorFailure(ret int, err error) (int, shared.Message) {
// 	return ret, shared.Message{Response: err.Error()}
// }

// func namedFailure(ret int, resp string) (int, shared.Message) {
// 	return ret, shared.Message{Response: resp}
// }

// func dbGroupFromMessage(cfg *shared.Config, msg shared.Message) (db.Groups, int, error) {
// 	var group db.Groups
...
// No input
// */
// func GetCA(cfg *shared.Config, authobj *auth.SessionInfo, msg shared.Message) (ret int, resp shared.Message) {
// 	var err error
...
// No input
// */
// func Test(cfg *shared.Config, authobj *auth.SessionInfo, msg shared.Message) (ret int, resp shared.Message) {
// 	resp.Response = "TEST OK.  Server version " + shared.SkdsVersion
// 	return
// }
...
// */
// func Setup(cfg *shared.Config, authobj *auth.SessionInfo, msg shared.Message) (ret int, resp shared.Message) {
// 	admin := new(db.Users)
// 	group := new(db.Groups)
